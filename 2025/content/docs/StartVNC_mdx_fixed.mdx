...
- Script works, although program doesn't auto start on startup
    - Potentially because:
        - Script doesn't wait properly for the wifi to connect 
        - Doesn't even attempt to run durring startup
